...
from aioscrapy.http import TextResponse
from aioscrapy.utils.response import get_meta_refresh
from aioscrapy.exceptions import IgnoreRequest, NotConfigured
