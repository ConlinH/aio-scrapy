...
class DemoMemorySpider(Spider):
    ...
    custom_settings = dict(
        ...
        PLAYWRIGHT_CLIENT_ARGS=dict(
            ...
            browser_args=dict(
                ...
                proxy=None, downloads_path=None, slow_mo=None, traces_dir=None, chromium_sandbox=None,
            ...
            context_args=dict(
                ...
                accept_downloads=None, default_browser_type=None, proxy=None, record_har_path=None,
    ...
    start_urls = ['https://hanyu.baidu.com/zici/s?wd=%E9%BB%84&query=%E9%BB%84']
